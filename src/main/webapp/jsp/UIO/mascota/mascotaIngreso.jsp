...
<body>
	<div class="content">
		...
		<form action="MascotaController?ruta=agregarMascota" method="POST"
			class="form-container">
			<!-- Campo ID de la Mascota (si es necesario) -->
			<input type="hidden" name="idCliente" value="${idCliente}"> <label
			...
			<input type="number" id="edad" name="edad" value="${mascota.edad}"
				required> <input type="hidden" name="idSucursal"
				value="Quito">

			<button type="submit" class="action-btn modify-btn">Guardar
				Mascota</button>
			<a
				href="${pageContext.request.contextPath}/QuitoViewController?ruta=verMascotas&idCliente=${mascota.idCliente}"
